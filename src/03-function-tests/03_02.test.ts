...
import {addGreeting, addMoneyToBudget, repairHouse, toFireStaff, toHireStaff} from './03';
...
test('Greeting message should be corrected for city', () => {
    const message = addGreeting(city)

    expect(message).toBe('Hello New York citizens. I want we all be happy. All 1000000 citizens')
})